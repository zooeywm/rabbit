...
use recorder::OpenTelemetryMetricsRecorderImpl;

pub(super) use runtime::{MetricsGuard, init};
...
impl<State: crate::app::container::network::outbound_port::NetworkState> NetworkMetricsRecorder
    for NetworkContainer<State>
{
